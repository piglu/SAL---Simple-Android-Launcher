...
Debug.ShouldStop(1073741824);
main.mostCurrent.__c.runVoidMethod ("LogImpl","3131105",RemoteObject.concat(RemoteObject.createImmutable("f.animStr: "),main.mostCurrent._f._animstr),0);
 BA.debugLineNum = 162;BA.debugLine="Log(\"f.brStranica: \" & f.brStranica)";
Debug.ShouldStop(2);
main.mostCurrent.__c.runVoidMethod ("LogImpl","3131108",RemoteObject.concat(RemoteObject.createImmutable("f.brStranica: "),main.mostCurrent._f._brstranica),0);
...
try {
		Debug.PushSubsStack("btnClearAll_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2475);
if (RapidSub.canDelegate("btnclearall_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btnclearall_click");}
 BA.debugLineNum = 2475;BA.debugLine="Sub btnClearAll_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2476;BA.debugLine="CallSubDelayed(NotificationService, \"ClearAll\")";
Debug.ShouldStop(2048);
...
try {
		Debug.PushSubsStack("btnDodajStr_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2507);
if (RapidSub.canDelegate("btndodajstr_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btndodajstr_click");}
 BA.debugLineNum = 2507;BA.debugLine="Sub btnDodajStr_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 2508;BA.debugLine="Log(\"btnDodajStr_Click\")";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33211265",RemoteObject.createImmutable("btnDodajStr_Click"),0);
...
try {
		Debug.PushSubsStack("btnDodajWidget_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2499);
if (RapidSub.canDelegate("btndodajwidget_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btndodajwidget_click");}
 BA.debugLineNum = 2499;BA.debugLine="Sub btnDodajWidget_Click";
Debug.ShouldStop(4);
 BA.debugLineNum = 2500;BA.debugLine="If Panel1.Visible Then";
Debug.ShouldStop(8);
if (main.mostCurrent._panel1.runMethod(true,"getVisible").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 2503;BA.debugLine="CreateSmartWidget(1)";
Debug.ShouldStop(64);
...
main.mostCurrent.__c.runVoidMethod ("LogImpl","31048577",RemoteObject.createImmutable("btnInfo klik!"),0);
...
try {
		Debug.PushSubsStack("btnKontaktEmail_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2870);
...
Debug.locals.put("ajtemID", _ajtemid);
 BA.debugLineNum = 2870;BA.debugLine="Sub btnKontaktEmail_Click(ajtemID As String)";
Debug.ShouldStop(2097152);
 BA.debugLineNum = 2872;BA.debugLine="Dim msg As Email";
Debug.ShouldStop(8388608);
_msg = RemoteObject.createNew ("anywheresoftware.b4a.phone.Phone.Email");Debug.locals.put("msg", _msg);
 BA.debugLineNum = 2874;BA.debugLine="Dim lEmail As List";
Debug.ShouldStop(33554432);
_lemail = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("lEmail", _lemail);
 BA.debugLineNum = 2875;BA.debugLine="lEmail.Initialize";
Debug.ShouldStop(67108864);
_lemail.runVoidMethod ("Initialize");
 BA.debugLineNum = 2876;BA.debugLine="Dim allContactEmails As List = cu.GetEmails(ajtem";
Debug.ShouldStop(134217728);
...
_allcontactemails = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getemails",(Object)(BA.numberCast(long.class, _ajtemid)));Debug.locals.put("allContactEmails", _allcontactemails);Debug.locals.put("allContactEmails", _allcontactemails);
 BA.debugLineNum = 2877;BA.debugLine="If allContactEmails.Size > 0 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean(">",_allcontactemails.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2878;BA.debugLine="For Each c As cuEmail In allContactEmails";
Debug.ShouldStop(536870912);
{
...
if (RemoteObject.solveBoolean("=",_adresa.runMethod(true,"equalsIgnoreCase",(Object)(RemoteObject.createImmutable("false"))),main.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 2889;BA.debugLine="msg.To.Add(adresa)";
Debug.ShouldStop(256);
_msg.getField(false,"To").runVoidMethod ("Add",(Object)((_adresa)));
 BA.debugLineNum = 2890;BA.debugLine="StartActivity(msg.GetIntent)";
Debug.ShouldStop(512);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_msg.runMethod(false,"GetIntent"))));
 }else {
 BA.debugLineNum = 2892;BA.debugLine="ToastMessageShow(\"You didn't choose email addr";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("ToastMessageShow",(Object)(BA.ObjectToCharSequence("You didn't choose email address!")),(Object)(main.mostCurrent.__c.getField(true,"False")));
 ...
 BA.debugLineNum = 2896;BA.debugLine="ToastMessageShow(\"No email address!\", False)";
...
try {
		Debug.PushSubsStack("btnKontaktInfo_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2818);
...
Debug.locals.put("ajtemID", _ajtemid);
 BA.debugLineNum = 2818;BA.debugLine="Sub btnKontaktInfo_Click(ajtemID As String)";
Debug.ShouldStop(2);
 BA.debugLineNum = 2821;BA.debugLine="Log(\"GetAccounts: \" & cu.GetAccounts(ajtemID))";
Debug.ShouldStop(16);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604483",RemoteObject.concat(RemoteObject.createImmutable("GetAccounts: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getaccounts",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2822;BA.debugLine="Log(\"GetEmails: \" & cu.GetEmails(ajtemID))";
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604484",RemoteObject.concat(RemoteObject.createImmutable("GetEmails: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getemails",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2823;BA.debugLine="Log(\"GetEvents: \" & cu.GetEvents(ajtemID))";
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604485",RemoteObject.concat(RemoteObject.createImmutable("GetEvents: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getevents",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2824;BA.debugLine="Log(\"GetGroups: \" & cu.GetGroups(ajtemID))";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604486",RemoteObject.concat(RemoteObject.createImmutable("GetGroups: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getgroups",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2825;BA.debugLine="Log(\"GetNameFromId: \" & cu.GetNameFromId(ajtemID)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604487",RemoteObject.concat(RemoteObject.createImmutable("GetNameFromId: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getnamefromid",(Object)(_ajtemid))),0);
 BA.debugLineNum = 2826;BA.debugLine="Log(\"GetNote: \" & cu.GetNote(ajtemID))";
Debug.ShouldStop(512);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604488",RemoteObject.concat(RemoteObject.createImmutable("GetNote: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getnote",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2827;BA.debugLine="Log(\"GetOrganization :\" & cu.GetOrganization(ajte";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604489",RemoteObject.concat(RemoteObject.createImmutable("GetOrganization :"),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getorganization",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2828;BA.debugLine="Log(\"GetPhones: \" & cu.GetPhones(ajtemID))";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604490",RemoteObject.concat(RemoteObject.createImmutable("GetPhones: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getphones",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
 BA.debugLineNum = 2829;BA.debugLine="Log(\"GetStarred: \" & cu.GetStarred(ajtemID))";
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33604491",RemoteObject.concat(RemoteObject.createImmutable("GetStarred: "),main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getstarred",(Object)(BA.numberCast(long.class, _ajtemid)))),0);
...
try {
		Debug.PushSubsStack("btnKontaktPoziv_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2832);
...
Debug.locals.put("ajtemID", _ajtemid);
 BA.debugLineNum = 2832;BA.debugLine="Sub btnKontaktPoziv_Click(ajtemID As String)";
Debug.ShouldStop(32768);
 BA.debugLineNum = 2834;BA.debugLine="Dim pc As PhoneCalls";
Debug.ShouldStop(131072);
_pc = RemoteObject.createNew ("anywheresoftware.b4a.phone.Phone.PhoneCalls");Debug.locals.put("pc", _pc);
 BA.debugLineNum = 2836;BA.debugLine="Dim lFoun As List";
Debug.ShouldStop(524288);
_lfoun = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("lFoun", _lfoun);
 BA.debugLineNum = 2837;BA.debugLine="lFoun.Initialize";
Debug.ShouldStop(1048576);
_lfoun.runVoidMethod ("Initialize");
 BA.debugLineNum = 2838;BA.debugLine="Dim allPhones As List = cu.GetPhones(ajtemID)";
Debug.ShouldStop(2097152);
...
_allphones = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getphones",(Object)(BA.numberCast(long.class, _ajtemid)));Debug.locals.put("allPhones", _allphones);Debug.locals.put("allPhones", _allphones);
 BA.debugLineNum = 2839;BA.debugLine="If allPhones.Size > 0 Then";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean(">",_allphones.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2840;BA.debugLine="For Each phone As cuPhone In cu.GetPhones(ajtemI";
Debug.ShouldStop(8388608);
{
...
Debug.locals.put("phone", _phone);
 BA.debugLineNum = 2842;BA.debugLine="lFoun.Add(phone.Number)";
Debug.ShouldStop(33554432);
_lfoun.runVoidMethod ("Add",(Object)((_phone.getField(true,"Number"))));
 }
}Debug.locals.put("phone", _phone);
;
 BA.debugLineNum = 2844;BA.debugLine="If lFoun.Size = 1 Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_lfoun.runMethod(true,"getSize"),BA.numberCast(double.class, 1))) { 
 BA.debugLineNum = 2845;BA.debugLine="StartActivity(pc.Call(lFoun.Get(0)))";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("btnKontaktSMS_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2855);
...
RemoteObject _phone = RemoteObject.declareNull("com.no3dlauncher.contactsutils._cuphone");
Debug.locals.put("ajtemID", _ajtemid);
 BA.debugLineNum = 2855;BA.debugLine="Sub btnKontaktSMS_Click(ajtemID As String)";
Debug.ShouldStop(64);
 BA.debugLineNum = 2857;BA.debugLine="Dim intent1 As Intent";
Debug.ShouldStop(256);
_intent1 = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("intent1", _intent1);
 BA.debugLineNum = 2859;BA.debugLine="Dim l As List = cu.GetPhones(ajtemID)";
Debug.ShouldStop(1024);
...
main.mostCurrent._l = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getphones",(Object)(BA.numberCast(long.class, _ajtemid)));
 BA.debugLineNum = 2860;BA.debugLine="If l.Size > 0 Then";
Debug.ShouldStop(2048);
if (RemoteObject.solveBoolean(">",main.mostCurrent._l.runMethod(true,"getSize"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2861;BA.debugLine="For Each phone As cuPhone In cu.GetPhones(ajtemI";
Debug.ShouldStop(4096);
{
...
;
 BA.debugLineNum = 2863;BA.debugLine="intent1.Initialize(intent1.ACTION_VIEW, \"sms:\" &";
Debug.ShouldStop(16384);
_intent1.runVoidMethod ("Initialize",(Object)(_intent1.getField(true,"ACTION_VIEW")),(Object)(RemoteObject.concat(RemoteObject.createImmutable("sms:"),_phone.getField(true,"Number"))));
 BA.debugLineNum = 2864;BA.debugLine="StartActivity(intent1)";
Debug.ShouldStop(32768);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_intent1.getObject())));
 }else {
 BA.debugLineNum = 2866;BA.debugLine="ToastMessageShow(\"No phone number so no SMS!\", F";
Debug.ShouldStop(131072);
...
try {
		Debug.PushSubsStack("btnNaprijed_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2524);
if (RapidSub.canDelegate("btnnaprijed_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btnnaprijed_click");}
 BA.debugLineNum = 2524;BA.debugLine="Sub btnNaprijed_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2525;BA.debugLine="If TabStrip1.CurrentPage < 3 Then";
Debug.ShouldStop(268435456);
if (RemoteObject.solveBoolean("<",main.mostCurrent._tabstrip1.runMethod(true,"getCurrentPage"),BA.numberCast(double.class, 3))) { 
 BA.debugLineNum = 2526;BA.debugLine="TabStrip1.ScrollTo(TabStrip1.CurrentPage + 1, Tr";
Debug.ShouldStop(536870912);
...
try {
		Debug.PushSubsStack("btnNatrag_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2511);
if (RapidSub.canDelegate("btnnatrag_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btnnatrag_click");}
 BA.debugLineNum = 2511;BA.debugLine="Sub btnNatrag_Click";
Debug.ShouldStop(16384);
 BA.debugLineNum = 2512;BA.debugLine="If TabStrip1.CurrentPage > 0 Then";
Debug.ShouldStop(32768);
if (RemoteObject.solveBoolean(">",main.mostCurrent._tabstrip1.runMethod(true,"getCurrentPage"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2513;BA.debugLine="TabStrip1.ScrollTo(TabStrip1.CurrentPage - 1, Tr";
Debug.ShouldStop(65536);
main.mostCurrent._tabstrip1.runVoidMethod ("ScrollTo",(Object)(RemoteObject.solve(new RemoteObject[] {main.mostCurrent._tabstrip1.runMethod(true,"getCurrentPage"),RemoteObject.createImmutable(1)}, "-",1, 1)),(Object)(main.mostCurrent.__c.getField(true,"True")));
 }else {
 BA.debugLineNum = 2515;BA.debugLine="TabStrip1.ScrollTo(2, True)";
Debug.ShouldStop(262144);
main.mostCurrent._tabstrip1.runVoidMethod ("ScrollTo",(Object)(BA.numberCast(int.class, 2)),(Object)(main.mostCurrent.__c.getField(true,"True")));
 ...
 BA.debugLineNum = 2519;BA.debugLine="If TabStrip1.CurrentPage = 1 And pnlKontakti.Numb";
Debug.ShouldStop(4194304);
if (RemoteObject.solveBoolean("=",main.mostCurrent._tabstrip1.runMethod(true,"getCurrentPage"),BA.numberCast(double.class, 1)) && RemoteObject.solveBoolean("=",main.mostCurrent._pnlkontakti.runMethod(true,"getNumberOfViews"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2520;BA.debugLine="UbaciKontakte2'(c)";
Debug.ShouldStop(8388608);
_ubacikontakte2();
 };
...
try {
		Debug.PushSubsStack("btnNotify_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2489);
...
RemoteObject _in = RemoteObject.declareNull("anywheresoftware.b4a.objects.IntentWrapper");
 BA.debugLineNum = 2489;BA.debugLine="Sub btnNotify_Click";
Debug.ShouldStop(16777216);
 BA.debugLineNum = 2490;BA.debugLine="Dim p As Phone";
Debug.ShouldStop(33554432);
_p = RemoteObject.createNew ("anywheresoftware.b4a.phone.Phone");Debug.locals.put("p", _p);
 BA.debugLineNum = 2491;BA.debugLine="Log(p.GetSettings(\"enabled_notification_listeners";
Debug.ShouldStop(67108864);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33080194",_p.runMethod(true,"GetSettings",(Object)(RemoteObject.createImmutable("enabled_notification_listeners"))),0);
 BA.debugLineNum = 2492;BA.debugLine="If p.GetSettings(\"enabled_notification_listeners\"";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_p.runMethod(true,"GetSettings",(Object)(RemoteObject.createImmutable("enabled_notification_listeners"))).runMethod(true,"contains",(Object)(RemoteObject.createImmutable("com.no3dlauncher"))),main.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 2493;BA.debugLine="Dim In As Intent";
Debug.ShouldStop(268435456);
_in = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("In", _in);
 BA.debugLineNum = 2494;BA.debugLine="In.Initialize(\"android.settings.ACTION_NOTIFICAT";
Debug.ShouldStop(536870912);
_in.runVoidMethod ("Initialize",(Object)(BA.ObjectToString("android.settings.ACTION_NOTIFICATION_LISTENER_SETTINGS")),(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2495;BA.debugLine="StartActivity(In)";
Debug.ShouldStop(1073741824);
...
try {
		Debug.PushSubsStack("btnPostavkeKontakti_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2924);
if (RapidSub.canDelegate("btnpostavkekontakti_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","btnpostavkekontakti_click");}
 BA.debugLineNum = 2924;BA.debugLine="Sub btnPostavkeKontakti_Click";
Debug.ShouldStop(2048);
 BA.debugLineNum = 2925;BA.debugLine="StartActivity(postavke_kontakti)";
Debug.ShouldStop(4096);
...
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31179654",RemoteObject.createImmutable("widgeti klik!"),0);
...
try {
		Debug.PushSubsStack("clv_ItemClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1341);
...
Debug.locals.put("Value", _value);
 BA.debugLineNum = 1341;BA.debugLine="Sub clv_ItemClick (Index As Int, Value As Object)";
Debug.ShouldStop(268435456);
 BA.debugLineNum = 1342;BA.debugLine="Dim in As Intent";
Debug.ShouldStop(536870912);
_in = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("in", _in);
 BA.debugLineNum = 1343;BA.debugLine="Dim pm As PackageManager";
Debug.ShouldStop(1073741824);
_pm = RemoteObject.createNew ("anywheresoftware.b4a.phone.PackageManagerWrapper");Debug.locals.put("pm", _pm);
 BA.debugLineNum = 1345;BA.debugLine="zadnja_oznacena_app = Index";
Debug.ShouldStop(1);
main._zadnja_oznacena_app = _index;
 BA.debugLineNum = 1346;BA.debugLine="in = pm.GetApplicationIntent(l1.Get(Index))";
Debug.ShouldStop(2);
_in = _pm.runMethod(false,"GetApplicationIntent",(Object)(BA.ObjectToString(main.mostCurrent._l1.runMethod(false,"Get",(Object)(_index)))));Debug.locals.put("in", _in);
 BA.debugLineNum = 1347;BA.debugLine="If in.IsInitialized Then";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("CreateSmartWidget (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2035);
...
Debug.locals.put("id", _id);
 BA.debugLineNum = 2035;BA.debugLine="Sub CreateSmartWidget(id As Int)";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2036;BA.debugLine="SmartWidgets.Initialize(\"SmartWidgets\", id)";
Debug.ShouldStop(524288);
main._smartwidgets.runVoidMethod ("Initialize",main.processBA,(Object)(BA.ObjectToString("SmartWidgets")),(Object)(_id));
 BA.debugLineNum = 2037;BA.debugLine="SmartWidgets.SelectWidget";
Debug.ShouldStop(1048576);
...
try {
		Debug.PushSubsStack("DodajAppUFavorite (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1071);
...
RemoteObject _bmp = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
 BA.debugLineNum = 1071;BA.debugLine="Sub DodajAppUFavorite";
Debug.ShouldStop(16384);
 BA.debugLineNum = 1072;BA.debugLine="Dim iv As ImageView";
Debug.ShouldStop(32768);
_iv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 1073;BA.debugLine="Dim pm As PackageManager";
Debug.ShouldStop(65536);
_pm = RemoteObject.createNew ("anywheresoftware.b4a.phone.PackageManagerWrapper");Debug.locals.put("pm", _pm);
 BA.debugLineNum = 1075;BA.debugLine="Dim pckg1 As String";
Debug.ShouldStop(262144);
_pckg1 = RemoteObject.createImmutable("");Debug.locals.put("pckg1", _pckg1);
 BA.debugLineNum = 1076;BA.debugLine="Dim pckg As String = Starter.mapa.GetKeyAt(zadnja";
Debug.ShouldStop(524288);
_pckg = BA.ObjectToString(main.mostCurrent._starter._mapa.runMethod(false,"GetKeyAt",(Object)(main._zadnja_oznacena_app)));Debug.locals.put("pckg", _pckg);Debug.locals.put("pckg", _pckg);
 BA.debugLineNum = 1078;BA.debugLine="ProvjeraAppUFavoritima(Starter.mapa.GetKeyAt(zadn";
Debug.ShouldStop(2097152);
...
_pckg1 = _pckg.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_pckg.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable(";"))),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(_pckg.runMethod(true,"length")));Debug.locals.put("pckg1", _pckg1);
 BA.debugLineNum = 1087;BA.debugLine="Dim bdw As BitmapDrawable = pm.GetApplicationIcon";
Debug.ShouldStop(1073741824);
...
_bdw.setObject(_pm.runMethod(false,"GetApplicationIcon",(Object)(_pckg1)));Debug.locals.put("bdw", _bdw);
 BA.debugLineNum = 1088;BA.debugLine="Dim bmp As Bitmap = bdw.Bitmap";
Debug.ShouldStop(-2147483648);
...
_bmp.setObject(_bdw.runMethod(false,"getBitmap"));Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 1089;BA.debugLine="bdw.Initialize(bmp.Resize(48dip, 48dip, True))";
Debug.ShouldStop(1);
_bdw.runVoidMethod ("Initialize",(Object)((_bmp.runMethod(false,"Resize",(Object)(BA.numberCast(float.class, main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))))),(Object)(BA.numberCast(float.class, main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))))),(Object)(main.mostCurrent.__c.getField(true,"True"))).getObject())));
 BA.debugLineNum = 1090;BA.debugLine="listaFavorita.Add(pckg1)	' dodaj ime paketa aplik";
Debug.ShouldStop(2);
main.mostCurrent._listafavorita.runVoidMethod ("Add",(Object)((_pckg1)));
 BA.debugLineNum = 1093;BA.debugLine="iv.Bitmap = bdw.Bitmap'bm1";
Debug.ShouldStop(16);
_iv.runMethod(false,"setBitmap",_bdw.runMethod(false,"getBitmap"));
 BA.debugLineNum = 1094;BA.debugLine="scvDock.Panel.AddView(iv, iv.Width*scvDock.Panel.";
Debug.ShouldStop(32);
main.mostCurrent._scvdock.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_iv.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_iv.runMethod(true,"getWidth"),main.mostCurrent._scvdock.runMethod(false,"getPanel").runMethod(true,"getNumberOfViews"),main.mostCurrent._scvdock.runMethod(false,"getPanel").runMethod(true,"getNumberOfViews"),main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))}, "*+*",1, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 10)))),(Object)(_iv.runMethod(true,"getWidth")),(Object)(_iv.runMethod(true,"getHeight")));
 BA.debugLineNum = 1096;BA.debugLine="ToastMessageShow(\"App added to favorites!\", True)";
Debug.ShouldStop(128);
...
parent.mostCurrent._wp1.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("wp1")));
 BA.debugLineNum = 878;BA.debugLine="pnl.AddView(wp1, 0, 0, 100%x, pnlMeni.Height)";
Debug.ShouldStop(8192);
_pnl.runVoidMethod ("AddView",(Object)((parent.mostCurrent._wp1.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(BA.numberCast(int.class, 0)),(Object)(parent.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 100)),main.mostCurrent.activityBA)),(Object)(parent.mostCurrent._pnlmeni.runMethod(true,"getHeight")));
 BA.debugLineNum = 881;BA.debugLine="Dim mylist As List";
Debug.ShouldStop(65536);
_mylist = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("mylist", _mylist);
 BA.debugLineNum = 882;BA.debugLine="mylist.Initialize";
Debug.ShouldStop(131072);
_mylist.runVoidMethod ("Initialize");
 BA.debugLineNum = 883;BA.debugLine="mylist.Add(LoadBitmap(File.DirAssets, \"act_add.pn";
Debug.ShouldStop(262144);
...
parent.mostCurrent._wp1.runVoidMethod ("setTypeface",parent.mostCurrent.__c.getField(false,"Typeface").runMethod(false,"LoadFromAssets",(Object)(RemoteObject.concat(parent.mostCurrent._f._wheellistfont,RemoteObject.createImmutable(".ttf")))));
 BA.debugLineNum = 897;BA.debugLine="Dim cd As ColorDrawable";
Debug.ShouldStop(1);
_cd = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.ColorDrawable");Debug.locals.put("cd", _cd);
 BA.debugLineNum = 898;BA.debugLine="Dim res(4) As Int";
Debug.ShouldStop(2);
_res = RemoteObject.createNewArray ("int", new int[] {4}, new Object[]{});Debug.locals.put("res", _res);
 BA.debugLineNum = 899;BA.debugLine="res = getARGB(f.bojaPozadine)";
Debug.ShouldStop(4);
_res = _getargb(parent.mostCurrent._f._bojapozadine);Debug.locals.put("res", _res);
 BA.debugLineNum = 900;BA.debugLine="res(0) = f.trans";
Debug.ShouldStop(8);
_res.setArrayElement (parent.mostCurrent._f._trans,BA.numberCast(int.class, 0));
 BA.debugLineNum = 901;BA.debugLine="cd.Initialize(Colors.ARGB(res(0), res(1), res(2),";
Debug.ShouldStop(16);
_cd.runVoidMethod ("Initialize",(Object)(parent.mostCurrent.__c.getField(false,"Colors").runMethod(true,"ARGB",(Object)(_res.getArrayElement(true,BA.numberCast(int.class, 0))),(Object)(_res.getArrayElement(true,BA.numberCast(int.class, 1))),(Object)(_res.getArrayElement(true,BA.numberCast(int.class, 2))),(Object)(_res.getArrayElement(true,BA.numberCast(int.class, 3))))),(Object)(BA.numberCast(int.class, 0)));
 BA.debugLineNum = 902;BA.debugLine="wp1.Background = cd";
Debug.ShouldStop(32);
parent.mostCurrent._wp1.runMethod(false,"setBackground",(_cd.getObject()));
 BA.debugLineNum = 903;BA.debugLine="wp1.Data = l";
Debug.ShouldStop(64);
parent.mostCurrent._wp1.runVoidMethod ("setData",(parent.mostCurrent._l.getObject()));
 BA.debugLineNum = 906;BA.debugLine="ivWheelDodaj.Initialize(\"ivWheelDodaj\")";
Debug.ShouldStop(512);
parent.mostCurrent._ivwheeldodaj.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("ivWheelDodaj")));
 BA.debugLineNum = 907;BA.debugLine="ivWheelDodaj.Tag = \"kotac_dodaj\"";
Debug.ShouldStop(1024);
parent.mostCurrent._ivwheeldodaj.runMethod(false,"setTag",RemoteObject.createImmutable(("kotac_dodaj")));
 BA.debugLineNum = 908;BA.debugLine="ivWheelDodaj.Bitmap = LoadBitmap(File.DirAssets,";
Debug.ShouldStop(2048);
parent.mostCurrent._ivwheeldodaj.runMethod(false,"setBitmap",(parent.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(parent.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("act_add.png"))).getObject()));
 BA.debugLineNum = 909;BA.debugLine="ivWheelDodaj.Gravity = Gravity.FILL";
Debug.ShouldStop(4096);
parent.mostCurrent._ivwheeldodaj.runMethod(true,"setGravity",parent.mostCurrent.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 910;BA.debugLine="pnl.AddView(ivWheelDodaj, wp1.Width, (pnlMeni.Hei";
Debug.ShouldStop(8192);
_pnl.runVoidMethod ("AddView",(Object)((parent.mostCurrent._ivwheeldodaj.getObject())),(Object)(parent.mostCurrent._wp1.runMethod(true,"getWidth")),(Object)(BA.numberCast(int.class, RemoteObject.solve(new RemoteObject[] {(RemoteObject.solve(new RemoteObject[] {parent.mostCurrent._pnlmeni.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "/",0, 0)),(RemoteObject.solve(new RemoteObject[] {parent.mostCurrent._btnpostavke.runMethod(true,"getHeight"),RemoteObject.createImmutable(2)}, "/",0, 0))}, "+",1, 0))),(Object)(parent.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 10)),main.mostCurrent.activityBA)),(Object)(parent.mostCurrent.__c.runMethod(true,"PerXToCurrent",(Object)(BA.numberCast(float.class, 10)),main.mostCurrent.activityBA)));
 BA.debugLineNum = 913;BA.debugLine="Wait For ivWheelDodaj_Click";
Debug.ShouldStop(65536);
...
this.state = -1;
;
 BA.debugLineNum = 915;BA.debugLine="Wait For wp1_index_clicked(position As Int)";
Debug.ShouldStop(262144);
...
Debug.ShouldStop(65536);
parent.mostCurrent._clv.runMethod(false,"_asview").runMethod(true,"setColor",BA.numberCast(int.class, _cd));
...
Debug.ShouldStop(4);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","31507364",RemoteObject.concat(RemoteObject.createImmutable("Selected item: "),_value),0);
...
try {
		Debug.PushSubsStack("getARGB (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1425);
if (RapidSub.canDelegate("getargb")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","getargb", _color);}
RemoteObject _res = null;
Debug.locals.put("Color", _color);
 BA.debugLineNum = 1425;BA.debugLine="Sub getARGB(Color As Int) As Int()";
Debug.ShouldStop(65536);
 BA.debugLineNum = 1426;BA.debugLine="Dim res(4) As Int";
Debug.ShouldStop(131072);
_res = RemoteObject.createNewArray ("int", new int[] {4}, new Object[]{});Debug.locals.put("res", _res);
 BA.debugLineNum = 1428;BA.debugLine="res(0) = Bit.UnsignedShiftRight(Bit.And(Color, 0x";
Debug.ShouldStop(524288);
_res.setArrayElement (main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"UnsignedShiftRight",(Object)(main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"And",(Object)(_color),(Object)(BA.numberCast(int.class, 0xff000000)))),(Object)(BA.numberCast(int.class, 24))),BA.numberCast(int.class, 0));
 BA.debugLineNum = 1429;BA.debugLine="res(1) = Bit.UnsignedShiftRight(Bit.And(Color, 0x";
Debug.ShouldStop(1048576);
_res.setArrayElement (main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"UnsignedShiftRight",(Object)(main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"And",(Object)(_color),(Object)(BA.numberCast(int.class, 0xff0000)))),(Object)(BA.numberCast(int.class, 16))),BA.numberCast(int.class, 1));
 BA.debugLineNum = 1430;BA.debugLine="res(2) = Bit.UnsignedShiftRight(Bit.And(Color, 0x";
Debug.ShouldStop(2097152);
_res.setArrayElement (main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"UnsignedShiftRight",(Object)(main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"And",(Object)(_color),(Object)(BA.numberCast(int.class, 0xff00)))),(Object)(BA.numberCast(int.class, 8))),BA.numberCast(int.class, 2));
 BA.debugLineNum = 1431;BA.debugLine="res(3) = Bit.And(Color, 0xff)";
Debug.ShouldStop(4194304);
_res.setArrayElement (main.mostCurrent.__c.getField(false,"Bit").runMethod(true,"And",(Object)(_color),(Object)(BA.numberCast(int.class, 0xff))),BA.numberCast(int.class, 3));
 BA.debugLineNum = 1433;BA.debugLine="Return res";
Debug.ShouldStop(16777216);
if (true) return _res;
...
main.mostCurrent._customlistview1 = RemoteObject.createNew ("b4a.example3.customlistview");
...
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31769478",BA.ObjectToString(_iv.runMethod(false,"getTag")),0);
...
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31638401",RemoteObject.createImmutable("ivapp long klik!"),0);
...
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31638404",BA.ObjectToString(_iv.runMethod(false,"getTag")),0);
...
try {
		Debug.PushSubsStack("ivClvDodaj_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1436);
...
RemoteObject _bdw = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.BitmapDrawable");
RemoteObject _bmp = RemoteObject.declareNull("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
 BA.debugLineNum = 1436;BA.debugLine="Sub ivClvDodaj_Click";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 1437;BA.debugLine="Dim iv As ImageView";
Debug.ShouldStop(268435456);
_iv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 1438;BA.debugLine="Dim pm As PackageManager";
Debug.ShouldStop(536870912);
_pm = RemoteObject.createNew ("anywheresoftware.b4a.phone.PackageManagerWrapper");Debug.locals.put("pm", _pm);
 BA.debugLineNum = 1440;BA.debugLine="If lbl.IsInitialized Then lbl.RemoveView";
Debug.ShouldStop(-2147483648);
...
main.mostCurrent._lbl.runVoidMethod ("RemoveView");};
 BA.debugLineNum = 1442;BA.debugLine="Private imgV As ImageView = Sender";
Debug.ShouldStop(2);
...
_imgv.setObject(main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));Debug.locals.put("imgV", _imgv);
 BA.debugLineNum = 1443;BA.debugLine="Private Index As Int = clv.GetItemFromView(Sender";
Debug.ShouldStop(4);
_index = main.mostCurrent._clv.runMethod(true,"_getitemfromview",RemoteObject.declareNull("anywheresoftware.b4a.AbsObjectWrapper").runMethod(false, "ConvertToWrapper", RemoteObject.createNew("anywheresoftware.b4a.objects.B4XViewWrapper"), main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA)));Debug.locals.put("Index", _index);Debug.locals.put("Index", _index);
 BA.debugLineNum = 1445;BA.debugLine="ProvjeraAppUFavoritima(Starter.mapa.GetKeyAt(Inde";
Debug.ShouldStop(16);
_provjeraappufavoritima(BA.ObjectToString(main.mostCurrent._starter._mapa.runMethod(false,"GetKeyAt",(Object)(_index))));
 BA.debugLineNum = 1447;BA.debugLine="iv.Initialize(\"ivMainApp\")";
Debug.ShouldStop(64);
_iv.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("ivMainApp")));
 BA.debugLineNum = 1448;BA.debugLine="iv.Tag = scvDock.Panel.NumberOfViews";
Debug.ShouldStop(128);
_iv.runMethod(false,"setTag",(main.mostCurrent._scvdock.runMethod(false,"getPanel").runMethod(true,"getNumberOfViews")));
 BA.debugLineNum = 1449;BA.debugLine="iv.Width = 48dip";
Debug.ShouldStop(256);
_iv.runMethod(true,"setWidth",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))));
 BA.debugLineNum = 1450;BA.debugLine="iv.Height = 48dip";
Debug.ShouldStop(512);
_iv.runMethod(true,"setHeight",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))));
 BA.debugLineNum = 1451;BA.debugLine="iv.Gravity = Gravity.FILL";
Debug.ShouldStop(1024);
_iv.runMethod(true,"setGravity",main.mostCurrent.__c.getField(false,"Gravity").getField(true,"FILL"));
 BA.debugLineNum = 1453;BA.debugLine="Dim pckg1 As String";
Debug.ShouldStop(4096);
_pckg1 = RemoteObject.createImmutable("");Debug.locals.put("pckg1", _pckg1);
 BA.debugLineNum = 1454;BA.debugLine="Dim pckg As String = Starter.mapa.GetKeyAt(Index)";
Debug.ShouldStop(8192);
_pckg = BA.ObjectToString(main.mostCurrent._starter._mapa.runMethod(false,"GetKeyAt",(Object)(_index)));Debug.locals.put("pckg", _pckg);Debug.locals.put("pckg", _pckg);
 BA.debugLineNum = 1455;BA.debugLine="pckg1 = pckg.SubString2(pckg.IndexOf(\";\")+1, pckg";
Debug.ShouldStop(16384);
_pckg1 = _pckg.runMethod(true,"substring",(Object)(RemoteObject.solve(new RemoteObject[] {_pckg.runMethod(true,"indexOf",(Object)(RemoteObject.createImmutable(";"))),RemoteObject.createImmutable(1)}, "+",1, 1)),(Object)(_pckg.runMethod(true,"length")));Debug.locals.put("pckg1", _pckg1);
 BA.debugLineNum = 1456;BA.debugLine="Dim bdw As BitmapDrawable = pm.GetApplicationIcon";
Debug.ShouldStop(32768);
_bdw = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.BitmapDrawable");
_bdw.setObject(_pm.runMethod(false,"GetApplicationIcon",(Object)(_pckg1)));Debug.locals.put("bdw", _bdw);
 BA.debugLineNum = 1457;BA.debugLine="Dim bmp As Bitmap = bdw.Bitmap";
Debug.ShouldStop(65536);
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_bmp.setObject(_bdw.runMethod(false,"getBitmap"));Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 1458;BA.debugLine="bdw.Initialize(bmp.Resize(48dip, 48dip, True))";
Debug.ShouldStop(131072);
_bdw.runVoidMethod ("Initialize",(Object)((_bmp.runMethod(false,"Resize",(Object)(BA.numberCast(float.class, main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))))),(Object)(BA.numberCast(float.class, main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 48))))),(Object)(main.mostCurrent.__c.getField(true,"True"))).getObject())));
 BA.debugLineNum = 1459;BA.debugLine="listaFavorita.Add(pckg1)	' dodaj ime paketa aplik";
Debug.ShouldStop(262144);
main.mostCurrent._listafavorita.runVoidMethod ("Add",(Object)((_pckg1)));
 BA.debugLineNum = 1462;BA.debugLine="iv.Bitmap = bdw.Bitmap'bm1";
Debug.ShouldStop(2097152);
_iv.runMethod(false,"setBitmap",_bdw.runMethod(false,"getBitmap"));
 BA.debugLineNum = 1463;BA.debugLine="scvDock.Panel.AddView(iv, iv.Width*scvDock.Panel.";
Debug.ShouldStop(4194304);
main.mostCurrent._scvdock.runMethod(false,"getPanel").runVoidMethod ("AddView",(Object)((_iv.getObject())),(Object)(RemoteObject.solve(new RemoteObject[] {_iv.runMethod(true,"getWidth"),main.mostCurrent._scvdock.runMethod(false,"getPanel").runMethod(true,"getNumberOfViews")}, "*",0, 1)),(Object)(main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(BA.numberCast(int.class, 4)))),(Object)(_iv.runMethod(true,"getWidth")),(Object)(_iv.runMethod(true,"getHeight")));
 BA.debugLineNum = 1552;BA.debugLine="imgV.Bitmap = LoadBitmap(File.DirAssets, \"act_add";
Debug.ShouldStop(32768);
_imgv.runMethod(false,"setBitmap",(main.mostCurrent.__c.runMethod(false,"LoadBitmap",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(RemoteObject.createImmutable("act_add_pressed.png"))).getObject()));
 BA.debugLineNum = 1554;BA.debugLine="File.WriteList(File.DirInternal, \"favorit_app\", l";
Debug.ShouldStop(131072);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("favorit_app")),(Object)(main.mostCurrent._listafavorita));
 BA.debugLineNum = 1556;BA.debugLine="ToastMessageShow(\"Application added to favorites.";
Debug.ShouldStop(524288);
...
try {
		Debug.PushSubsStack("ivDokPokreniApp_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1570);
...
RemoteObject _iv = RemoteObject.declareNull("anywheresoftware.b4a.objects.ImageViewWrapper");
RemoteObject _pm = RemoteObject.declareNull("anywheresoftware.b4a.phone.PackageManagerWrapper");
 BA.debugLineNum = 1570;BA.debugLine="Sub ivDokPokreniApp_Click";
Debug.ShouldStop(2);
 BA.debugLineNum = 1571;BA.debugLine="Log(\"klik!\")";
Debug.ShouldStop(4);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32621441",RemoteObject.createImmutable("klik!"),0);
 BA.debugLineNum = 1572;BA.debugLine="Dim in As Intent";
Debug.ShouldStop(8);
_in = RemoteObject.createNew ("anywheresoftware.b4a.objects.IntentWrapper");Debug.locals.put("in", _in);
 BA.debugLineNum = 1573;BA.debugLine="Dim iv As ImageView";
Debug.ShouldStop(16);
_iv = RemoteObject.createNew ("anywheresoftware.b4a.objects.ImageViewWrapper");Debug.locals.put("iv", _iv);
 BA.debugLineNum = 1574;BA.debugLine="Dim pm As PackageManager";
Debug.ShouldStop(32);
_pm = RemoteObject.createNew ("anywheresoftware.b4a.phone.PackageManagerWrapper");Debug.locals.put("pm", _pm);
 BA.debugLineNum = 1576;BA.debugLine="iv = Sender";
Debug.ShouldStop(128);
_iv.setObject(main.mostCurrent.__c.runMethod(false,"Sender",main.mostCurrent.activityBA));
 BA.debugLineNum = 1577;BA.debugLine="Log(iv.Tag)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32621447",BA.ObjectToString(_iv.runMethod(false,"getTag")),0);
 BA.debugLineNum = 1579;BA.debugLine="Log(listaFavorita.Get(iv.Tag))";
Debug.ShouldStop(1024);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32621449",BA.ObjectToString(main.mostCurrent._listafavorita.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _iv.runMethod(false,"getTag"))))),0);
 BA.debugLineNum = 1580;BA.debugLine="in = pm.GetApplicationIntent(listaFavorita.Get(iv";
Debug.ShouldStop(2048);
_in = _pm.runMethod(false,"GetApplicationIntent",(Object)(BA.ObjectToString(main.mostCurrent._listafavorita.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _iv.runMethod(false,"getTag")))))));Debug.locals.put("in", _in);
 BA.debugLineNum = 1581;BA.debugLine="If in.IsInitialized Then";
Debug.ShouldStop(4096);
if (_in.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
 BA.debugLineNum = 1584;BA.debugLine="StartActivity(in)";
Debug.ShouldStop(32768);
main.mostCurrent.__c.runVoidMethod ("StartActivity",main.processBA,(Object)((_in.getObject())));
 };
...
try {
		Debug.PushSubsStack("ivWheelDodaj_Click (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1099);
if (RapidSub.canDelegate("ivwheeldodaj_click")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","ivwheeldodaj_click");}
 BA.debugLineNum = 1099;BA.debugLine="Sub ivWheelDodaj_Click";
Debug.ShouldStop(1024);
 BA.debugLineNum = 1100;BA.debugLine="Log(\"vil dodaj klik!\")";
Debug.ShouldStop(2048);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32031617",RemoteObject.createImmutable("vil dodaj klik!"),0);
 BA.debugLineNum = 1102;BA.debugLine="ivWheelDodaj.BringToFront";
Debug.ShouldStop(8192);
main.mostCurrent._ivwheeldodaj.runVoidMethod ("BringToFront");
 BA.debugLineNum = 1107;BA.debugLine="If lbl.IsInitialized Then lbl.RemoveView";
Debug.ShouldStop(262144);
if (main.mostCurrent._lbl.runMethod(true,"IsInitialized").<Boolean>get().booleanValue()) { 
main.mostCurrent._lbl.runVoidMethod ("RemoveView");};
 BA.debugLineNum = 1118;BA.debugLine="ProvjeraAppUFavoritima(Starter.mapa.GetKeyAt(zadn";
Debug.ShouldStop(536870912);
_provjeraappufavoritima(BA.ObjectToString(main.mostCurrent._starter._mapa.runMethod(false,"GetKeyAt",(Object)(main._zadnja_oznacena_app))));
 BA.debugLineNum = 1119;BA.debugLine="DodajAppUFavorite";
Debug.ShouldStop(1073741824);
_dodajappufavorite();
 BA.debugLineNum = 1217;BA.debugLine="File.WriteList(File.DirInternal, \"favorit_app\", l";
Debug.ShouldStop(1);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteList",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("favorit_app")),(Object)(main.mostCurrent._listafavorita));
...
try {
		Debug.PushSubsStack("kontaktiGrid_FinishedLoading (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2652);
if (RapidSub.canDelegate("kontaktigrid_finishedloading")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","kontaktigrid_finishedloading");}
 BA.debugLineNum = 2652;BA.debugLine="Sub kontaktiGrid_FinishedLoading";
Debug.ShouldStop(134217728);
 BA.debugLineNum = 2653;BA.debugLine="ProgressDialogHide";
Debug.ShouldStop(268435456);
...
try {
		Debug.PushSubsStack("kontaktiGrid_ItemClicked (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2632);
...
Debug.locals.put("Item", _item);
 BA.debugLineNum = 2632;BA.debugLine="Sub kontaktiGrid_ItemClicked(Item As String)";
Debug.ShouldStop(128);
 BA.debugLineNum = 2633;BA.debugLine="Log(Item)";
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33473409",_item,0);
 BA.debugLineNum = 2634;BA.debugLine="Dim ll As List";
Debug.ShouldStop(512);
_ll = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("ll", _ll);
 BA.debugLineNum = 2635;BA.debugLine="ll.Initialize";
Debug.ShouldStop(1024);
_ll.runVoidMethod ("Initialize");
 BA.debugLineNum = 2636;BA.debugLine="ll.AddAll(Array As String(\"Call\", \"SMS\", \"EMail\",";
Debug.ShouldStop(2048);
_ll.runVoidMethod ("AddAll",(Object)(main.mostCurrent.__c.runMethod(false, "ArrayToList", (Object)(RemoteObject.createNewArray("String",new int[] {4},new Object[] {BA.ObjectToString("Call"),BA.ObjectToString("SMS"),BA.ObjectToString("EMail"),RemoteObject.createImmutable("Info")})))));
 BA.debugLineNum = 2637;BA.debugLine="Dim x As id";
Debug.ShouldStop(4096);
_x = RemoteObject.createNew ("com.maximus.id.id");Debug.locals.put("x", _x);
 BA.debugLineNum = 2638;BA.debugLine="Dim m As Int = x.InputList1(ll, \"\")";
Debug.ShouldStop(8192);
_m = _x.runMethodAndSync(true,"InputList1",(Object)(_ll),(Object)(RemoteObject.createImmutable("")),main.mostCurrent.activityBA);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2639;BA.debugLine="Log(m)";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33473415",BA.NumberToString(_m),0);
 BA.debugLineNum = 2640;BA.debugLine="Select m";
Debug.ShouldStop(32768);
...
try {
		Debug.PushSubsStack("KreirajStavku (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1324);
...
Debug.locals.put("Height", _height);
 BA.debugLineNum = 1324;BA.debugLine="Sub KreirajStavku(b As Bitmap, imeApp As String, W";
Debug.ShouldStop(2048);
 BA.debugLineNum = 1325;BA.debugLine="Dim p As Panel";
Debug.ShouldStop(4096);
_p = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("p", _p);
 BA.debugLineNum = 1327;BA.debugLine="p.Initialize(\"\")";
Debug.ShouldStop(16384);
_p.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 1328;BA.debugLine="p.Color = Colors.Transparent";
Debug.ShouldStop(32768);
_p.runVoidMethod ("setColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Transparent"));
 BA.debugLineNum = 1329;BA.debugLine="p.SetLayout(0, btnPostavke.Height, Width, Height)";
Debug.ShouldStop(65536);
...
try {
		Debug.PushSubsStack("lblImeApp_LongClick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1421);
if (RapidSub.canDelegate("lblimeapp_longclick")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","lblimeapp_longclick");}
 BA.debugLineNum = 1421;BA.debugLine="Sub lblImeApp_LongClick";
Debug.ShouldStop(4096);
 BA.debugLineNum = 1422;BA.debugLine="Log(\"lblimeapp long klik!\")";
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32359297",RemoteObject.createImmutable("lblimeapp long klik!"),0);
...
try {
		Debug.PushSubsStack("Osvjezi (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1360);
if (RapidSub.canDelegate("osvjezi")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","osvjezi");}
 BA.debugLineNum = 1360;BA.debugLine="Sub Osvjezi";
Debug.ShouldStop(32768);
 BA.debugLineNum = 1361;BA.debugLine="f.UcitajVrijednostiOpt";
Debug.ShouldStop(65536);
main.mostCurrent._f.runVoidMethod ("_ucitajvrijednostiopt",main.mostCurrent.activityBA);
 BA.debugLineNum = 1363;BA.debugLine="ViewsBringToFront";
Debug.ShouldStop(262144);
_viewsbringtofront();
 BA.debugLineNum = 1365;BA.debugLine="If scvDock.IsInitialized Then scvDock.Panel.Remov";
Debug.ShouldStop(1048576);
...
main.mostCurrent._scvdock.runMethod(false,"getPanel").runVoidMethod ("RemoveAllViews");};
 BA.debugLineNum = 1371;BA.debugLine="ShowFavoriteApps";
Debug.ShouldStop(67108864);
_showfavoriteapps();
...
try {
		Debug.PushSubsStack("PrikaziListuBrojevaTelefona (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2912);
...
Debug.locals.put("listaBrojeva", _listabrojeva);
 BA.debugLineNum = 2912;BA.debugLine="Sub PrikaziListuBrojevaTelefona(listaBrojeva As Li";
Debug.ShouldStop(-2147483648);
 BA.debugLineNum = 2913;BA.debugLine="Dim x As id";
Debug.ShouldStop(1);
_x = RemoteObject.createNew ("com.maximus.id.id");Debug.locals.put("x", _x);
 BA.debugLineNum = 2914;BA.debugLine="Dim m As Int = x.InputList1(listaBrojeva, \"\")";
Debug.ShouldStop(2);
_m = _x.runMethodAndSync(true,"InputList1",(Object)(_listabrojeva),(Object)(RemoteObject.createImmutable("")),main.mostCurrent.activityBA);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2917;BA.debugLine="If m >= 0 Then";
Debug.ShouldStop(16);
if (RemoteObject.solveBoolean("g",_m,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2918;BA.debugLine="Return listaBrojeva.Get(m)";
Debug.ShouldStop(32);
if (true) return BA.ObjectToString(_listabrojeva.runMethod(false,"Get",(Object)(_m)));
 }else {
 BA.debugLineNum = 2920;BA.debugLine="Return False";
Debug.ShouldStop(128);
...
try {
		Debug.PushSubsStack("PrikaziListuEmailAdresaUDijalogu (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2900);
...
Debug.locals.put("listaAdresa", _listaadresa);
 BA.debugLineNum = 2900;BA.debugLine="Sub PrikaziListuEmailAdresaUDijalogu(listaAdresa A";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2901;BA.debugLine="Dim x As id";
Debug.ShouldStop(1048576);
_x = RemoteObject.createNew ("com.maximus.id.id");Debug.locals.put("x", _x);
 BA.debugLineNum = 2902;BA.debugLine="Dim m As Int = x.InputList1(listaAdresa, \"\")";
Debug.ShouldStop(2097152);
_m = _x.runMethodAndSync(true,"InputList1",(Object)(_listaadresa),(Object)(RemoteObject.createImmutable("")),main.mostCurrent.activityBA);Debug.locals.put("m", _m);Debug.locals.put("m", _m);
 BA.debugLineNum = 2905;BA.debugLine="If m >= 0 Then";
Debug.ShouldStop(16777216);
if (RemoteObject.solveBoolean("g",_m,BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2906;BA.debugLine="Return listaAdresa.Get(m)";
Debug.ShouldStop(33554432);
if (true) return BA.ObjectToString(_listaadresa.runMethod(false,"Get",(Object)(_m)));
 }else {
 BA.debugLineNum = 2908;BA.debugLine="Return False";
Debug.ShouldStop(134217728);
if (true) return BA.ObjectToString(main.mostCurrent.__c.getField(true,"False"));
 };
...
try {
		Debug.PushSubsStack("ProvjeraAppUFavoritima (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1559);
...
Debug.locals.put("mapavrijednost", _mapavrijednost);
 BA.debugLineNum = 1559;BA.debugLine="Sub ProvjeraAppUFavoritima(mapavrijednost As Strin";
Debug.ShouldStop(4194304);
 BA.debugLineNum = 1560;BA.debugLine="Dim brAppUDoku As Int = scvDock.Panel.NumberOfVie";
Debug.ShouldStop(8388608);
_brappudoku = main.mostCurrent._scvdock.runMethod(false,"getPanel").runMethod(true,"getNumberOfViews");Debug.locals.put("brAppUDoku", _brappudoku);Debug.locals.put("brAppUDoku", _brappudoku);
 BA.debugLineNum = 1562;BA.debugLine="For i = 0 To brAppUDoku - 1";
Debug.ShouldStop(33554432);
{
final int step2 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 1563;BA.debugLine="Dim s As String = listaFavorita.Get(i)";
Debug.ShouldStop(67108864);
_s = BA.ObjectToString(main.mostCurrent._listafavorita.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _i))));Debug.locals.put("s", _s);Debug.locals.put("s", _s);
 BA.debugLineNum = 1564;BA.debugLine="If mapavrijednost.Contains(s) = True Then";
Debug.ShouldStop(134217728);
if (RemoteObject.solveBoolean("=",_mapavrijednost.runMethod(true,"contains",(Object)(_s)),main.mostCurrent.__c.getField(true,"True"))) { 
 BA.debugLineNum = 1565;BA.debugLine="ToastMessageShow(\"App already in favorites!\", F";
Debug.ShouldStop(268435456);
...
Debug.ShouldStop(8);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31245185",RemoteObject.createImmutable("scvDock long klik"),0);
...
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31310727",_tag,0);
 BA.debugLineNum = 591;BA.debugLine="Log(listaFavorita.Get(Tag))";
Debug.ShouldStop(16384);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31310728",BA.ObjectToString(main.mostCurrent._listafavorita.runMethod(false,"Get",(Object)(BA.numberCast(int.class, _tag)))),0);
 };
...
try {
		Debug.PushSubsStack("SmartWidgets_BackPressed (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2183);
...
Debug.locals.put("WidgetId", _widgetid);
 BA.debugLineNum = 2183;BA.debugLine="Sub SmartWidgets_BackPressed (WidgetId As Int)";
Debug.ShouldStop(64);
 BA.debugLineNum = 2184;BA.debugLine="Log(\"Back pressed\")";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32883585",RemoteObject.createImmutable("Back pressed"),0);
...
try {
		Debug.PushSubsStack("SmartWidgets_WidgetCreated (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2068);
...
Debug.locals.put("widgetinfo", _widgetinfo);
 BA.debugLineNum = 2068;BA.debugLine="Sub SmartWidgets_WidgetCreated (HostId As Int, Hos";
Debug.ShouldStop(524288);
 BA.debugLineNum = 2069;BA.debugLine="Dim widget_panel As Panel";
Debug.ShouldStop(1048576);
_widget_panel = RemoteObject.createNew ("anywheresoftware.b4a.objects.PanelWrapper");Debug.locals.put("widget_panel", _widget_panel);
 BA.debugLineNum = 2071;BA.debugLine="Dim Info As RSWidgetProviderInfo = widgetinfo";
Debug.ShouldStop(4194304);
...
_info.setObject(_widgetinfo);Debug.locals.put("Info", _info);
 BA.debugLineNum = 2072;BA.debugLine="Dim hw As RSWidgetHostView = HostView";
Debug.ShouldStop(8388608);
...
_hw.setObject(_hostview);Debug.locals.put("hw", _hw);
 BA.debugLineNum = 2080;BA.debugLine="Log(hw)";
Debug.ShouldStop(-2147483648);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818060",BA.ObjectToString(_hw),0);
 BA.debugLineNum = 2081;BA.debugLine="Log(HostId)";
Debug.ShouldStop(1);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818061",BA.NumberToString(_hostid),0);
 BA.debugLineNum = 2082;BA.debugLine="Log(WidgetId)";
Debug.ShouldStop(2);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818062",BA.NumberToString(_widgetid),0);
 BA.debugLineNum = 2083;BA.debugLine="widget_panel.Initialize(\"\")";
Debug.ShouldStop(4);
_widget_panel.runVoidMethod ("Initialize",main.mostCurrent.activityBA,(Object)(RemoteObject.createImmutable("")));
 BA.debugLineNum = 2084;BA.debugLine="widget_panel = hw'HostView' SmartWidgets.HostView";
Debug.ShouldStop(8);
_widget_panel.setObject(_hw.getObject());
 BA.debugLineNum = 2085;BA.debugLine="Log(hw)";
Debug.ShouldStop(16);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818065",BA.ObjectToString(_hw),0);
 BA.debugLineNum = 2086;BA.debugLine="Log(HostId)";
Debug.ShouldStop(32);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818066",BA.NumberToString(_hostid),0);
 BA.debugLineNum = 2087;BA.debugLine="Log(WidgetId)";
Debug.ShouldStop(64);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818067",BA.NumberToString(_widgetid),0);
 BA.debugLineNum = 2088;BA.debugLine="If DipToCurrent(Info.MinWidth) > GetDeviceLayoutV";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean(">",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(_info.runMethod(true,"getMinWidth"))),BA.numberCast(double.class, main.mostCurrent.__c.runMethod(false,"GetDeviceLayoutValues",main.mostCurrent.activityBA).getField(true,"Width")))) { 
 BA.debugLineNum = 2089;BA.debugLine="widget_panel.Width = Info.MinWidth";
Debug.ShouldStop(256);
_widget_panel.runMethod(true,"setWidth",_info.runMethod(true,"getMinWidth"));
 }else {
 BA.debugLineNum = 2091;BA.debugLine="widget_panel.Width = DipToCurrent(Info.MinWidth)";
Debug.ShouldStop(1024);
_widget_panel.runMethod(true,"setWidth",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(_info.runMethod(true,"getMinWidth"))));
 ...
 BA.debugLineNum = 2094;BA.debugLine="If DipToCurrent(Info.MinHeight) > GetDeviceLayout";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean(">",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(_info.runMethod(true,"getMinHeight"))),BA.numberCast(double.class, main.mostCurrent.__c.runMethod(false,"GetDeviceLayoutValues",main.mostCurrent.activityBA).getField(true,"Height")))) { 
 BA.debugLineNum = 2095;BA.debugLine="widget_panel.Height = Info.MinHeight";
Debug.ShouldStop(16384);
_widget_panel.runMethod(true,"setHeight",_info.runMethod(true,"getMinHeight"));
 }else {
 BA.debugLineNum = 2097;BA.debugLine="widget_panel.Height = DipToCurrent(Info.MinHeigh";
Debug.ShouldStop(65536);
_widget_panel.runMethod(true,"setHeight",main.mostCurrent.__c.runMethod(true,"DipToCurrent",(Object)(_info.runMethod(true,"getMinHeight"))));
 ...
 BA.debugLineNum = 2100;BA.debugLine="ipsilon = widget_panel.Height";
Debug.ShouldStop(524288);
main._ipsilon = _widget_panel.runMethod(true,"getHeight");
 BA.debugLineNum = 2101;BA.debugLine="SmartWidgets.AddView(Panel1, widget_panel, 0, top";
Debug.ShouldStop(1048576);
main._smartwidgets.runVoidMethod ("AddView",(Object)(main.mostCurrent._panel1),(Object)((_widget_panel.getObject())),(Object)(BA.numberCast(int.class, 0)),(Object)(main._topw));
 BA.debugLineNum = 2102;BA.debugLine="topW = topW + ipsilon";
Debug.ShouldStop(2097152);
main._topw = RemoteObject.solve(new RemoteObject[] {main._topw,main._ipsilon}, "+",1, 1);
 BA.debugLineNum = 2112;BA.debugLine="Log(hw)";
Debug.ShouldStop(-2147483648);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32818092",BA.ObjectToString(_hw),0);
 BA.debugLineNum = 2113;BA.debugLine="SmartWidgets.StartListening";
Debug.ShouldStop(1);
main._smartwidgets.runVoidMethod ("StartListening");
 BA.debugLineNum = 2177;BA.debugLine="File.WriteString(File.DirInternal, \"thehost.txt\",";
Debug.ShouldStop(1);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("thehost.txt")),(Object)(BA.ObjectToString(_hostview)));
 BA.debugLineNum = 2178;BA.debugLine="File.writestring(File.DirInternal, \"theid.txt\", H";
Debug.ShouldStop(2);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("WriteString",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString("theid.txt")),(Object)(BA.NumberToString(_hostid)));
 BA.debugLineNum = 2179;BA.debugLine="File.WriteString(File.DirInternal, \"theappid.txt\"";
Debug.ShouldStop(4);
...
try {
		Debug.PushSubsStack("TabStrip1_PageSelected (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2023);
...
Debug.locals.put("Position", _position);
 BA.debugLineNum = 2023;BA.debugLine="Sub TabStrip1_PageSelected (Position As Int)";
Debug.ShouldStop(64);
 BA.debugLineNum = 2024;BA.debugLine="Log($\"Current page: ${Position}\"$)";
Debug.ShouldStop(128);
main.mostCurrent.__c.runVoidMethod ("LogImpl","32686977",(RemoteObject.concat(RemoteObject.createImmutable("Current page: "),main.mostCurrent.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_position))),RemoteObject.createImmutable(""))),0);
 BA.debugLineNum = 2025;BA.debugLine="Dim i As Int";
Debug.ShouldStop(256);
_i = RemoteObject.createImmutable(0);Debug.locals.put("i", _i);
 BA.debugLineNum = 2026;BA.debugLine="For Each lbl As Label In GetAllTabLabels(TabStrip";
Debug.ShouldStop(512);
main.mostCurrent._lbl = RemoteObject.createNew ("anywheresoftware.b4a.objects.LabelWrapper");
{
...
main.mostCurrent._lbl.setObject(group3.runMethod(false,"Get",index3));
 BA.debugLineNum = 2027;BA.debugLine="If i = Position Then lbl.TextColor = Colors.Blue";
Debug.ShouldStop(1024);
...
main.mostCurrent._lbl.runMethod(true,"setTextColor",main.mostCurrent.__c.getField(false,"Colors").getField(true,"Red"));};
 BA.debugLineNum = 2028;BA.debugLine="i = i + 1";
Debug.ShouldStop(2048);
_i = RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(1)}, "+",1, 1);Debug.locals.put("i", _i);
 }
};
 BA.debugLineNum = 2030;BA.debugLine="If TabStrip1.CurrentPage = 1 And pnlKontakti.Numb";
Debug.ShouldStop(8192);
if (RemoteObject.solveBoolean("=",main.mostCurrent._tabstrip1.runMethod(true,"getCurrentPage"),BA.numberCast(double.class, 1)) && RemoteObject.solveBoolean("=",main.mostCurrent._pnlkontakti.runMethod(true,"getNumberOfViews"),BA.numberCast(double.class, 0))) { 
 BA.debugLineNum = 2031;BA.debugLine="UbaciKontakte2";
Debug.ShouldStop(16384);
_ubacikontakte2();
 };
...
try {
		Debug.PushSubsStack("tajmer_Tick (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2483);
if (RapidSub.canDelegate("tajmer_tick")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","tajmer_tick");}
 BA.debugLineNum = 2483;BA.debugLine="Sub tajmer_Tick";
Debug.ShouldStop(262144);
 BA.debugLineNum = 2484;BA.debugLine="NotificationService.brojNotifikacija = 0";
Debug.ShouldStop(524288);
main.mostCurrent._notificationservice._brojnotifikacija = BA.numberCast(int.class, 0);
 BA.debugLineNum = 2485;BA.debugLine="CallSubDelayed(NotificationService, \"GetActive\")";
Debug.ShouldStop(1048576);
main.mostCurrent.__c.runVoidMethod ("CallSubDelayed",main.processBA,(Object)((main.mostCurrent._notificationservice.getObject())),(Object)(RemoteObject.createImmutable("GetActive")));
 BA.debugLineNum = 2486;BA.debugLine="Log(NotificationService.brojNotifikacija)";
Debug.ShouldStop(2097152);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33014659",BA.NumberToString(main.mostCurrent._notificationservice._brojnotifikacija),0);
...
try {
		Debug.PushSubsStack("UbaciKontakte2 (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,2530);
...
RemoteObject _out = RemoteObject.declareNull("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");
 BA.debugLineNum = 2530;BA.debugLine="Sub UbaciKontakte2";
Debug.ShouldStop(2);
 BA.debugLineNum = 2531;BA.debugLine="Dim allContacts As List = cu.FindAllContacts(True";
Debug.ShouldStop(4);
...
_allcontacts = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_findallcontacts",(Object)(main.mostCurrent.__c.getField(true,"True")));Debug.locals.put("allContacts", _allcontacts);Debug.locals.put("allContacts", _allcontacts);
 BA.debugLineNum = 2536;BA.debugLine="If File.Exists (File.DirInternal, \"nema_slike.png";
Debug.ShouldStop(128);
if (RemoteObject.solveBoolean("=",main.mostCurrent.__c.getField(false,"File").runMethod(true,"Exists",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("nema_slike.png"))),main.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 2537;BA.debugLine="File.Copy(File.DirAssets, \"nema_slike.png\", File";
Debug.ShouldStop(256);
main.mostCurrent.__c.getField(false,"File").runVoidMethod ("Copy",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirAssets")),(Object)(BA.ObjectToString("nema_slike.png")),(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("nema_slike.png")));
 ...
 BA.debugLineNum = 2540;BA.debugLine="grid.Initialize(pnlKontakti, Me, \"kontaktiGrid\",";
Debug.ShouldStop(2048);
main.mostCurrent._grid.runVoidMethod ("_initialize",main.mostCurrent.activityBA,(Object)(main.mostCurrent._pnlkontakti),(Object)(main.getObject()),(Object)(BA.ObjectToString("kontaktiGrid")),(Object)(BA.numberCast(int.class, 4)),(Object)(RemoteObject.createImmutable("S")));
 BA.debugLineNum = 2542;BA.debugLine="grid.PrepareGridView";
Debug.ShouldStop(8192);
main.mostCurrent._grid.runVoidMethod ("_preparegridview");
 BA.debugLineNum = 2562;BA.debugLine="Dim ukupno, i As Int = 0";
Debug.ShouldStop(2);
...
_i = BA.numberCast(int.class, 0);Debug.locals.put("i", _i);Debug.locals.put("i", _i);
 BA.debugLineNum = 2564;BA.debugLine="ProgressDialogShow(\"Building contacts...\")";
Debug.ShouldStop(8);
main.mostCurrent.__c.runVoidMethod ("ProgressDialogShow",main.mostCurrent.activityBA,(Object)(BA.ObjectToCharSequence(RemoteObject.createImmutable("Building contacts..."))));
 BA.debugLineNum = 2565;BA.debugLine="Dim l1k, l2k As List";
Debug.ShouldStop(16);
...
_l2k = RemoteObject.createNew ("anywheresoftware.b4a.objects.collections.List");Debug.locals.put("l2k", _l2k);
 BA.debugLineNum = 2566;BA.debugLine="l1k.Initialize	' diaply name";
Debug.ShouldStop(32);
_l1k.runVoidMethod ("Initialize");
 BA.debugLineNum = 2567;BA.debugLine="l2k.Initialize	' id";
Debug.ShouldStop(64);
_l2k.runVoidMethod ("Initialize");
 BA.debugLineNum = 2568;BA.debugLine="For Each c As cuContact In allContacts'cu.FindAll";
Debug.ShouldStop(128);
{
...
Debug.locals.put("c", _c);
 BA.debugLineNum = 2569;BA.debugLine="l1k.Add(c.DisplayName)";
Debug.ShouldStop(256);
_l1k.runVoidMethod ("Add",(Object)((_c.getField(true,"DisplayName"))));
 BA.debugLineNum = 2570;BA.debugLine="l2k.Add(c.Id)";
Debug.ShouldStop(512);
_l2k.runVoidMethod ("Add",(Object)((_c.getField(true,"Id"))));
 }
}Debug.locals.put("c", _c);
;
 BA.debugLineNum = 2573;BA.debugLine="Log(l1k)";
Debug.ShouldStop(4096);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33407915",BA.ObjectToString(_l1k),0);
 BA.debugLineNum = 2574;BA.debugLine="Log(l2k)";
Debug.ShouldStop(8192);
main.mostCurrent.__c.runVoidMethod ("LogImpl","33407916",BA.ObjectToString(_l2k),0);
 BA.debugLineNum = 2575;BA.debugLine="For i = 0 To allContacts.Size - 1";
Debug.ShouldStop(16384);
{
final int step18 = 1;
...
Debug.locals.put("i", _i);
 BA.debugLineNum = 2576;BA.debugLine="For j = 0 To 4";
Debug.ShouldStop(32768);
{
final int step19 = 1;
final int limit19 = 4;
...
Debug.locals.put("j", _j);
 BA.debugLineNum = 2577;BA.debugLine="If ukupno < allContacts.Size Then";
Debug.ShouldStop(65536);
if (RemoteObject.solveBoolean("<",_ukupno,BA.numberCast(double.class, _allcontacts.runMethod(true,"getSize")))) { 
 BA.debugLineNum = 2579;BA.debugLine="Dim bmp As Bitmap = cu.GetPhoto(l2k.Get(i*5+j)";
Debug.ShouldStop(262144);
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_bmp = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getphoto",(Object)(BA.numberCast(long.class, _l2k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 2580;BA.debugLine="If bmp.IsInitialized = False Then";
Debug.ShouldStop(524288);
if (RemoteObject.solveBoolean("=",_bmp.runMethod(true,"IsInitialized"),main.mostCurrent.__c.getField(true,"False"))) { 
 BA.debugLineNum = 2581;BA.debugLine="grid.AddToGridView(File.Combine(File.DirInter";
Debug.ShouldStop(1048576);
main.mostCurrent._grid.runVoidMethod ("_addtogridview",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(RemoteObject.createImmutable("nema_slike.png")))),(Object)(BA.ObjectToString(_l1k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))),(Object)(BA.ObjectToString(_l2k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))));
 ...
 BA.debugLineNum = 2583;BA.debugLine="Dim bmp As Bitmap = cu.GetPhoto(l2k.Get(i*5+j";
Debug.ShouldStop(4194304);
_bmp = RemoteObject.createNew ("anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper");
_bmp = main._cu.runClassMethod (com.no3dlauncher.contactsutils.class, "_getphoto",(Object)(BA.numberCast(long.class, _l2k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))));Debug.locals.put("bmp", _bmp);Debug.locals.put("bmp", _bmp);
 BA.debugLineNum = 2584;BA.debugLine="Dim Out As OutputStream";
Debug.ShouldStop(8388608);
_out = RemoteObject.createNew ("anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper");Debug.locals.put("Out", _out);
 BA.debugLineNum = 2585;BA.debugLine="Out = File.OpenOutput(File.DirInternal, l1k.G";
Debug.ShouldStop(16777216);
_out = main.mostCurrent.__c.getField(false,"File").runMethod(false,"OpenOutput",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString(_l1k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))),(Object)(main.mostCurrent.__c.getField(true,"False")));Debug.locals.put("Out", _out);
 BA.debugLineNum = 2586;BA.debugLine="bmp.WriteToStream(Out, 100, \"PNG\")";
Debug.ShouldStop(33554432);
_bmp.runVoidMethod ("WriteToStream",(Object)((_out.getObject())),(Object)(BA.numberCast(int.class, 100)),(Object)(BA.getEnumFromString(BA.getDeviceClass("android.graphics.Bitmap.CompressFormat"),RemoteObject.createImmutable("PNG"))));
 BA.debugLineNum = 2587;BA.debugLine="Out.Close";
Debug.ShouldStop(67108864);
_out.runVoidMethod ("Close");
 BA.debugLineNum = 2588;BA.debugLine="grid.AddToGridView(File.Combine(File.DirInter";
Debug.ShouldStop(134217728);
main.mostCurrent._grid.runVoidMethod ("_addtogridview",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"Combine",(Object)(main.mostCurrent.__c.getField(false,"File").runMethod(true,"getDirInternal")),(Object)(BA.ObjectToString(_l1k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))))),(Object)(BA.ObjectToString(_l1k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))),(Object)(BA.ObjectToString(_l2k.runMethod(false,"Get",(Object)(RemoteObject.solve(new RemoteObject[] {_i,RemoteObject.createImmutable(5),RemoteObject.createImmutable(_j)}, "*+",1, 1))))));
 };
 BA.debugLineNum = 2616;BA.debugLine="ukupno = ukupno + 1";
Debug.ShouldStop(8388608);
...
;
 BA.debugLineNum = 2624;BA.debugLine="grid.TitleBoxVisible = True";
Debug.ShouldStop(-2147483648);
main.mostCurrent._grid.runVoidMethod ("_settitleboxvisible",main.mostCurrent.__c.getField(true,"True"));
 BA.debugLineNum = 2627;BA.debugLine="grid.ShowGridView";
Debug.ShouldStop(4);
...
Debug.ShouldStop(33554432);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31703941",RemoteObject.concat(RemoteObject.createImmutable("package:"),_pkg),0);
...
try {
		Debug.PushSubsStack("ViewsBringToFront (main) ","main",0,main.mostCurrent.activityBA,main.mostCurrent,1354);
if (RapidSub.canDelegate("viewsbringtofront")) { return com.no3dlauncher.main.remoteMe.runUserSub(false, "main","viewsbringtofront");}
 BA.debugLineNum = 1354;BA.debugLine="Sub ViewsBringToFront";
Debug.ShouldStop(512);
 BA.debugLineNum = 1355;BA.debugLine="btnSearch.BringToFront";
Debug.ShouldStop(1024);
main.mostCurrent._btnsearch.runVoidMethod ("BringToFront");
 BA.debugLineNum = 1356;BA.debugLine="btnNotify.BringToFront";
Debug.ShouldStop(2048);
main.mostCurrent._btnnotify.runVoidMethod ("BringToFront");
 BA.debugLineNum = 1357;BA.debugLine="btnPostavke.BringToFront";
Debug.ShouldStop(4096);
...
Debug.ShouldStop(256);
main.mostCurrent.__c.runVoidMethod ("LogImpl","31441798",main.mostCurrent._f._animstr,0);
