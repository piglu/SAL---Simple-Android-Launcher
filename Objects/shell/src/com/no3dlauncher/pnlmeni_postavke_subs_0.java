...
Debug.ShouldStop(1048576);
pnlmeni_postavke.mostCurrent.__c.runVoidMethod ("LogImpl","71114114",RemoteObject.createImmutable("juzer klouzed"),0);
...
Debug.ShouldStop(1024);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71441801",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 0))),0);
 BA.debugLineNum = 140;BA.debugLine="Log(res(1))";
Debug.ShouldStop(2048);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71441802",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 1))),0);
 BA.debugLineNum = 141;BA.debugLine="Log(res(2))";
Debug.ShouldStop(4096);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71441803",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 2))),0);
 BA.debugLineNum = 142;BA.debugLine="Log(res(3))";
Debug.ShouldStop(8192);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71441804",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 3))),0);
...
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71507337",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 0))),0);
 BA.debugLineNum = 158;BA.debugLine="Log(res(1))";
Debug.ShouldStop(536870912);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71507338",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 1))),0);
 BA.debugLineNum = 159;BA.debugLine="Log(res(2))";
Debug.ShouldStop(1073741824);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71507339",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 2))),0);
 BA.debugLineNum = 160;BA.debugLine="Log(res(3))";
Debug.ShouldStop(-2147483648);
parent.mostCurrent.__c.runVoidMethod ("LogImpl","71507340",BA.NumberToString(_res.getArrayElement(true,BA.numberCast(int.class, 3))),0);
