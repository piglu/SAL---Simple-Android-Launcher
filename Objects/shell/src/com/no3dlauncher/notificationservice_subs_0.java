...
notificationservice.mostCurrent.__c.runVoidMethod ("LogImpl","76553608",BA.ObjectToString(_extras),0);
...
notificationservice.mostCurrent.__c.runVoidMethod ("LogImpl","76553610",RemoteObject.concat(RemoteObject.createImmutable("Title = "),_title),notificationservice.mostCurrent.__c.getField(false,"Colors").getField(true,"Blue"));
...
Debug.ShouldStop(2);
notificationservice.mostCurrent.__c.runVoidMethod ("LogImpl","76619137",RemoteObject.concat(RemoteObject.createImmutable("NotificationRemoved, package = "),_sbn.runMethod(true,"getPackageName"),RemoteObject.createImmutable(", id = "),_sbn.runMethod(true,"getId"),RemoteObject.createImmutable(", text = "),_sbn.runMethod(true,"getTickerText")),0);
