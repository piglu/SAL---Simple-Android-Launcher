...
RDebugUtils.currentLine=6684672;
 //BA.debugLineNum = 6684672;BA.debugLine="Sub ClearAll";
RDebugUtils.currentLine=6684673;
 //BA.debugLineNum = 6684673;BA.debugLine="listener.ClearAll";
_listener.ClearAll();
...
RDebugUtils.currentLine=6750208;
 //BA.debugLineNum = 6750208;BA.debugLine="Sub GetActive";
RDebugUtils.currentLine=6750209;
 //BA.debugLineNum = 6750209;BA.debugLine="listener.GetActiveNotifications";
...
RDebugUtils.currentLine=6553600;
 //BA.debugLineNum = 6553600;BA.debugLine="Sub Listener_NotificationPosted (SBN As StatusBarN";
RDebugUtils.currentLine=6553601;
 //BA.debugLineNum = 6553601;BA.debugLine="brojNotifikacija = brojNotifikacija + 1";
_brojnotifikacija = (int) (_brojnotifikacija+1);
RDebugUtils.currentLine=6553602;
 //BA.debugLineNum = 6553602;BA.debugLine="Log(\"NotificationPosted, package = \" & SBN.Packag";
anywheresoftware.b4a.keywords.Common.LogImpl("76553602","NotificationPosted, package = "+_sbn.getPackageName()+", id = "+BA.NumberToString(_sbn.getId())+", text = "+_sbn.getTickerText(),0);
RDebugUtils.currentLine=6553603;
 //BA.debugLineNum = 6553603;BA.debugLine="Dim p As Phone";
_p = new anywheresoftware.b4a.phone.Phone();
RDebugUtils.currentLine=6553604;
 //BA.debugLineNum = 6553604;BA.debugLine="If p.SdkVersion >= 19 Then";
if (_p.getSdkVersion()>=19) { 
RDebugUtils.currentLine=6553605;
 //BA.debugLineNum = 6553605;BA.debugLine="Dim jno As JavaObject = SBN.Notification";
_jno = new anywheresoftware.b4j.object.JavaObject();
_jno.setObject((java.lang.Object)(_sbn.getNotification().getObject()));
RDebugUtils.currentLine=6553606;
 //BA.debugLineNum = 6553606;BA.debugLine="Dim extras As JavaObject = jno.GetField(\"extras\"";
...
RDebugUtils.currentLine=6553607;
 //BA.debugLineNum = 6553607;BA.debugLine="extras.RunMethod(\"size\", Null)";
_extras.RunMethod("size",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
RDebugUtils.currentLine=6553608;
 //BA.debugLineNum = 6553608;BA.debugLine="Log(extras)";
anywheresoftware.b4a.keywords.Common.LogImpl("76553608",BA.ObjectToString(_extras),0);
RDebugUtils.currentLine=6553609;
 //BA.debugLineNum = 6553609;BA.debugLine="Dim title As String = extras.RunMethod(\"getStrin";
_title = BA.ObjectToString(_extras.RunMethod("getString",new Object[]{(Object)("android.title")}));
RDebugUtils.currentLine=6553610;
 //BA.debugLineNum = 6553610;BA.debugLine="LogColor(\"Title = \" & title, Colors.Blue)";
anywheresoftware.b4a.keywords.Common.LogImpl("76553610","Title = "+_title,anywheresoftware.b4a.keywords.Common.Colors.Blue);
RDebugUtils.currentLine=6553611;
 //BA.debugLineNum = 6553611;BA.debugLine="Dim bmp As Bitmap = jno.GetField(\"largeIcon\")";
...
RDebugUtils.currentLine=6619136;
 //BA.debugLineNum = 6619136;BA.debugLine="Sub Listener_NotificationRemoved (SBN As StatusBar";
RDebugUtils.currentLine=6619137;
 //BA.debugLineNum = 6619137;BA.debugLine="Log(\"NotificationRemoved, package = \" & SBN.Packa";
anywheresoftware.b4a.keywords.Common.LogImpl("76619137","NotificationRemoved, package = "+_sbn.getPackageName()+", id = "+BA.NumberToString(_sbn.getId())+", text = "+_sbn.getTickerText(),0);
RDebugUtils.currentLine=6619139;
 //BA.debugLineNum = 6619139;BA.debugLine="brojNotifikacija = brojNotifikacija - 1";
_brojnotifikacija = (int) (_brojnotifikacija-1);
...
RDebugUtils.currentLine=6422528;
 //BA.debugLineNum = 6422528;BA.debugLine="Sub Service_Create";
RDebugUtils.currentLine=6422529;
 //BA.debugLineNum = 6422529;BA.debugLine="listener.Initialize(\"listener\")";
...
RDebugUtils.currentLine=6815744;
 //BA.debugLineNum = 6815744;BA.debugLine="Sub Service_Destroy";
...
RDebugUtils.currentLine=6488065;
 //BA.debugLineNum = 6488065;BA.debugLine="If listener.HandleIntent(StartingIntent) Then Ret";
